...
import { Edit, AlignVerticalJustifyCenter, Search } from 'lucide-react'
...
export function TablaObjetivos({ userRucEntidad }: PropiedadesTablaObjetivos) {
  ...
  const [objetivoSeleccionadoParaProgramas, setObjetivoSeleccionadoParaProgramas] = useState<ObjetivoEstrategico | null>(null)
            ...
            <TableBody>
              {objetivos.map((objetivo) => (
                <TableRow key={objetivo._id}>
                  ...
                  <TableCell className="text-center">
                    <Button variant="ghost" size="sm" disabled={objetivo.estado === 'ELIMINADO'}>
